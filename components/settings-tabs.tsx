                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => setCalendarSettings({ ...calendarSettings, showToolInfo: checked })}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">案件のステータスが変更された時に通知を受け取ります</p>
                  </div>
                  <Switch
                    id="project-updates"
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">1日のすべてのアクティビティのサマリーを受け取ります</p>
                  </div>
                  <Switch
                    id="daily-digest"
